...
def function_to_be_tested(brand, OS, comm, pay, minutes):
    return True
...
class TestParameterized(object):
    @pytest.mark.parametrize(["brand", "OS", "comm", "pay", "minutes"],
        [ value_list for value_list in AllPairs(parameters, filter_func=is_valid_combination)])

    def test(self, brand, OS, comm, pay, minutes):
        assert function_to_be_tested(brand, OS, comm, pay, minutes)
